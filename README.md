...
* **Directory:** [`/Customer-Churn-Analysis`](https://www.google.com/search?q=./Customer-Churn-Analysis/)
...
* **Directory:** [`/Used-Car-Price-Prediction`](https://www.google.com/search?q=./Used-Car-Price-Prediction/)
...
* **Directory:** [`/FDA-Drug-Adverse-Event-Classification`](https://www.google.com/search?q=./FDA-Drug-Adverse-Event-Classification/)
...
```bash
# Clone the portfolio
git clone https://github.com/Ahmed-Shehab-Source/Data-Science-Portfolio.git
...
* **Domain Focus:** Pharmacovigilance Analytics, Public Health Risk Assessment, Business Intelligence, Predictive Market Modeling
